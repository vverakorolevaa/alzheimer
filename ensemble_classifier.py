"""
Мультимодальный ансамблевый классификатор AD или здоровый.
...
Итоговое решение: среднее вероятностей трёх голов.
"""
...
class CompositionHead(nn.Module):
    """Head 2: клеточный состав образца."""
...
class EnsembleClassifier:
    """
    Подготовка данных, обучение трёх голов, ансамбль, метрики.
    """
